...
## File Structure
*   If you run the code with Method 1:
...
*   If you run the code with Method 2:
    models_commands.txt(help file pretty much) MUST be in the same directory as your Model file(eg. model_commands_short.txt) directory.
