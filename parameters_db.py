...
LLAMA_CPP_PARAMETERS = [
    ...
    },
    {
        ...
        "collapsed": True,
        "parameters": [
            {'name': 'SWA Full', 'id': 'swa-full', 'type': 'checkbox', 'default': False, 'description': 'Use full-size SWA cache (default: false). Environment variable: LLAMA_ARG_SWA_FULL', 'prefix': '--swa-full'},
            {'name': 'KV Unified', 'id': 'kv-unified', 'type': 'checkbox', 'default': False, 'description': 'Use single unified KV buffer for the KV cache of all sequences (default: false). Environment variable: LLAMA_ARG_KV_SPLIT', 'prefix': '-kvu'},
            {'name': 'Flash Attention', 'id': 'flash-attn', 'type': 'checkbox', 'default': False, 'description': 'Enable Flash Attention (default: disabled). Environment variable: LLAMA_ARG_FLASH_ATTN', 'prefix': '-fa'},
            {'name': 'No Performance', 'id': 'no-perf', 'type': 'checkbox', 'default': False, 'description': 'Disable internal libllama performance timings (default: false). Environment variable: LLAMA_ARG_NO_PERF', 'prefix': '--no-perf'},
            {'name': 'No KV Offload', 'id': 'no-kv-offload', 'type': 'checkbox', 'default': False, 'description': 'Disable KV offload. Environment variable: LLAMA_ARG_NO_KV_OFFLOAD', 'prefix': '-nkvo'},
            {'name': 'No Repack', 'id': 'no-repack', 'type': 'checkbox', 'default': False, 'description': 'Disable weight repacking. Environment variable: LLAMA_ARG_NO_REPACK', 'prefix': '-nr'},
            {'name': 'Cache Type K', 'id': 'cache-type-k', 'type': 'select', 'default': 'f16', 'options': ['f32', 'f16', 'bf16', 'q8_0', 'q4_0', 'q4_1', 'iq4_nl', 'q5_0', 'q5_1'], 'description': 'KV cache data type for K (default: f16). Environment variable: LLAMA_ARG_CACHE_TYPE_K', 'prefix': '-ctk'},
            {'name': 'Cache Type V', 'id': 'cache-type-v', 'type': 'select', 'default': 'f16', 'options': ['f32', 'f16', 'bf16', 'q8_0', 'q4_0', 'q4_1', 'iq4_nl', 'q5_0', 'q5_1'], 'description': 'KV cache data type for V (default: f16). Environment variable: LLAMA_ARG_CACHE_TYPE_V', 'prefix': '-ctv'},
            {'name': 'Parallel', 'id': 'parallel', 'type': 'number', 'default': '1', 'description': 'Number of parallel sequences to decode (default: 1). Environment variable: LLAMA_ARG_N_PARALLEL', 'prefix': '-np'},
        ]
    },
    {
